...
var satellite = L.tileLayer('http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png', {
        minZoom: 1,
        maxZoom: 18
    });
// var crop_map= L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {

var crop_map = L.tileLayer('tiles3/{z}/{x}/{y}.png', {tms: true,
        minZoom: 1,
        maxZoom: 18
         });
...
var map = L.map('map', {
    ...
    maxBounds:[[57.28, -120.46],[33.31, -73.32]]
